package com.corp.nurfia.recyclerview;
...
public class ListHeroAdapter extends RecyclerView.Adapter<ListHeroAdapter.ListViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ListViewHolder listViewHolder, int i) {
        //memasukkan data dari ArrayList
        listViewHolder.tvName.setText(getHeroes().get(i).getName());
        listViewHolder.tvDescription.setText(getHeroes().get(i).getDescription());

        Glide.with(context).load(getHeroes().get(i).getPhoto()).apply(new RequestOptions().override(55,55)).into(listViewHolder.imgPhoto);
    }

    @Override
    public int getItemCount() {
        //menampung data untuk 1 item
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView) {
            super(itemView); //merujuk item_hero.xml
